  ...
  <section class="sheet">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td class="text-center align-middle"><?php echo $data->status_peserta_pemilu; ?>"
        </td>
      </tr>
      <tr>
        <th class="text-center align-middle">Dapil</th>
        <td class="text-center align-middle"><?php echo $data->dapil; ?>"
        </td>
      </tr>
      <tr>
        <th class="text-center align-middle">Tempat</th>
        <td class="text-center align-middle">
          <?php echo $data->provinsi_nama; ?>, <?php echo $data->kota_nama; ?>, <?php echo $data->kelurahan_nama; ?>, <?php echo $data->kelurahan_nama; ?></td>
      </tr>
      <tr>
