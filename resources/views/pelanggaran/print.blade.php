    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center align-middle"><?php echo $data->nama_partai; ?></td>
          <td class="text-center align-middle"><?php echo $data->status_peserta_pemilu; ?></td>
          <td class="text-center align-middle"><?php echo $data->nama_bacaleg; ?></td>
          <td class="text-center align-middle"><?php echo $data->dapil; ?></td>
          <td class="text-center align-middle"><img src="<?php echo $data->bukti; ?>" alt="Bukti Pendukung" width="50px"
              height="50px"> </td>
          <td class="text-center align-middle"><?php echo $data->tanggal_input; ?></td>
