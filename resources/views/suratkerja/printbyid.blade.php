...
<body>
  <section class="sheet">
    ...
    <table class="table">
      <tr>
        <th class="text-center align-middle">Surat Kerja</th>
        <td class="text-center align-middle"><?php echo $data->nomor_surat_kerja; ?></td>
      </tr>
      <tr>
        <th class="text-center align-middle">Nama Bawaslu</th>
        <td class="text-center align-middle"><?php echo $data->bawaslu_kota_name; ?></td>
      </tr>
      <tr>
        <th class="text-center align-middle">Nama Panwascam</th>
        <td class="text-center align-middle"><?php echo $data->panwascam_name; ?></td>
      </tr>
    </table>
    <?php endforeach; ?>
