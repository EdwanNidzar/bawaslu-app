    ...
    <table class="table">
      <thead>
        <tr>
          ...
          <th class="text-center align-middle">Nomor Partai</th>
          <th class="text-center align-middle">Nama Partai</th>
          <th class="text-center align-middle">Photo Partai</th>
          <th class="text-center align-middle">Jumlah Pelanggaran</th>
        </tr>
      </thead>
      <tbody>
        <?php $no = 1; ?>
        <?php foreach ($parpol as $data) : ?>
        <tr>
          <td class="text-center align-middle"><?php echo $no; ?></td>
          <td class="text-center align-middle"><?php echo $data->nomor_partai; ?></td>
          <td class="text-center align-middle"><?php echo $data->nama_partai; ?></td>
          <td class="text-center align-middle"><img src="<?php echo $data->photo_partai; ?>" alt="Logo Partai" width="50px"
              height="50px"> </td>
